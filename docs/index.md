...
Step – 3: Enter the name servers for free hosting, set the Name Servers as ns1.server-host.top and ns2.server-host.top. For Premium hosting, set the name servers as dns1.infinitzhost.com and dns2.infinitzhost.com.
